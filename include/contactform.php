            ...
            <div class="row">
                <div class="col">
                    <form action="" method="GET">
                        <input type="text" class="form-control form1" placeholder="Name" />
                        <input type="email" class="form-control form1" placeholder="Email" />
                        <input type="text" class="form-control form1" placeholder="Subject" />
                    </form>
                </div>
                <div class="col">
                    <textarea placeholder="Your message here..." class="form-control form1" rows="3"></textarea>
